...
const antiDiabeteOffers: Offer[] = [
  ...
  },
  {
    ...
    saving: 'Tu économises 12 500 FCFA',
    badge: '⭐ LE PLUS RECOMMANDÉ',
    recommended: true,
  },
  {
    id: 23,
    label: 'CURE LONGUE DURÉE — 5 SACHETS',
    units: 5,
    paidUnits: 5,
    bonusUnits: 0,
    price: 38000,
    oldPrice: 62500,
    description: 'Stock longue durée + accompagnement optimal',
    saving: 'Tu économises 24 500 FCFA',
