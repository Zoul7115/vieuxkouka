...
const FAQ_DATA = [
  ...
  { q: "En combien de temps je vois les résultats ?", a: "<strong>Dès J3 :</strong> 87% de nos clients ressentent les premiers soulagements (saignements qui diminuent, brûlures qui calment). <strong>Entre J7 et J14 :</strong> guérison complète pour la grande majorité. Pour les cas très anciens (plus de 5 ans), prévois plusieurs sachets pour la cure complète." },
  { q: "Combien de sachets dois-je prendre ?", a: "<strong>1 sachet</strong> = pour démarrer le traitement. Tu peux en recommander un autre si tu as besoin de continuer la cure ou pour traiter quelqu'un d'autre dans la famille." },
